  ...
  return (
    <div className="relative min-h-screen w-screen flex items-center justify-center px-4 text-white box-border bg-[#040816]">
      ...
      <motion.div
        ...
        initial="hidden"
        animate="visible"
        className="relative z-10 w-full max-w-[440px] bg-slate-900/30 border border-white/[0.08] backdrop-blur-2xl rounded-[32px] p-8 md:px-10 py-12 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.6)] flex flex-col gap-8"
      >
        {/* HEADER SECTION */}
